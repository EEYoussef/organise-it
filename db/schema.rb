...
ActiveRecord::Schema.define(version: 2022_03_18_082602) do
  ...
  create_table "payments", force: :cascade do |t|
    ...
    t.bigint "freelanceruser_id", null: false
    t.bigint "user_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["freelanceruser_id"], name: "index_payments_on_freelanceruser_id"
  ...
  add_foreign_key "payments", "users", column: "freelanceruser_id"
